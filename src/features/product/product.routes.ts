...
import { allProducts, allSellerProduct, createProduct, deleteProduct, getProductById, updateProduct, updateProductDocument, updateProductImage } from './product.controller';
