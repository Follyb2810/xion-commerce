...
router.post("/add_to_cart", auth_1.auth, (0, checkCache_1.default)((req) => `carts:${req._id}`), cart_controller_1.addToCart);
...
router.get("/user_cart", auth_1.auth, (0, checkCache_1.default)((req) => `cart-${req._id}`), cart_controller_1.getCart);
